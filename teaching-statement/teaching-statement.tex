...
\newcommand{\schoolname}{\textcolor{red}{COLLEGE\_NAME}\xspace} % overwritten by individual school include
\newif\iflongdei
\longdeifalse % can be overwritten by individual school include
\newif\ifappendix
\appendixtrue % can be overwritten by individual school include
