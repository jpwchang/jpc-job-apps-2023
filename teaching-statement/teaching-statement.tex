...
\newcommand{\schoolname}{\textcolor{red}{COLLEGE\_NAME}\xspace} % overwritten by individual school header
\newif\iflongdei
\longdeifalse % can be overwritten by individual school header
\newif\ifappendix
\appendixtrue % can be overwritten by individual school header
